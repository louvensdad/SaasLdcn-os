...
import type { Organization } from '@contracts/tenant.contract';

export type { Organization } from '@contracts/tenant.contract';
...
export const tenantsClient = {
  organizations: () => send<Organization[]>('/api/organizations', { method: 'GET' }),
};
