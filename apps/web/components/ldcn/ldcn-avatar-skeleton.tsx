    ...
    >
      ...
      <div className="relative space-y-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.32em] text-[color:var(--muted)]">Avatar skeleton</p>
            <p className="mt-1 text-sm font-semibold text-[color:var(--text)]">Reserved presence node</p>
          </div>
        ...
        <div className="relative mx-auto flex aspect-[2.2/1] w-full max-w-[13rem] items-center justify-end overflow-hidden rounded-[var(--radius-xl)] border border-white/10 bg-black/10 px-4 py-3">
          ...
          <div className="relative flex items-center gap-3">
            ...
            <div className="grid gap-1 text-right">
              <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[color:var(--muted)]">Telemetry</p>
              <p className="text-xs font-semibold text-[color:var(--text)]">Passive observer</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-2">
          <div className="rounded-[var(--radius-xl)] border border-white/10 bg-white/[0.04] px-3 py-2">
            <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[color:var(--muted)]">Mode</p>
          ...
          <div className="rounded-[var(--radius-xl)] border border-white/10 bg-black/10 px-3 py-2">
            <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[color:var(--muted)]">Style</p>
            <p className="mt-1 text-sm font-semibold text-[color:var(--text)]">{avatarState.style ?? 'abstract'}</p>
          </div>
        </div>
      </div>
    </div>
