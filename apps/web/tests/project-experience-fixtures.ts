...
// Shared network-mock fixtures for the /projects/[projectId] page, used by
// BOTH project-experience-v2.spec.ts and live-preview-external-open.spec.ts.
// Deliberately NOT a .spec.ts file: Playwright refuses to let one test file
// import another ("test file should not import test file"), so this common
// setup lives in its own plain module instead of being re-exported from a spec.
