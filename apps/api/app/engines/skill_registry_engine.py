...
SKILLS: list[dict[str, Any]] = [
    ...
    _skill(
        ...
        "architecture",
        "Inspect architectural graph structure, ownership, dependencies and warnings.",
        ["graph", "architecture", "ownership"],
        ["Architecture selection exists"],
        ["Inspect architecture before generation", "Review graph ownership before handoff"],
    ...
    _skill(
        ...
        "Inspect Graph",
        "architecture",
        "Inspect architectural graph nodes and edges from the persisted project snapshot.",
        ["graph", "dependencies", "ownership"],
        ["Architectural graph snapshot exists or can be derived locally"],
        ["Inspect graph after Gatekeeper", "Review graph before handoff"],
        [_dep("architectural_graph.preview", "Architectural graph preview endpoint", "endpoint")],
        maturity="stable",
        execution_mode="read_only",
    ),
