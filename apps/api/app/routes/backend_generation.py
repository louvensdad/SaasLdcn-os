...
def preview_backend_generation(payload: BackendGenerationRequest) -> GenerationManifest:
...
def run_backend_generation(payload: BackendGenerationRequest) -> GenerationManifest:
    project = project_service.get_project(payload.project_id)
